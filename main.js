...
const validateCred = (cardNumber) => {
  ...
  if (sumChecker % 10 === 0) {
    console.log('Card is Valid. card number: ' + cardNumber + '         //Valid'); //debug log
    return true;
  } else {
    console.log('Card is not Valid, check and try again.' + 'card number: ' + cardNumber+ '         //Invalid'); //debug log
    return false;
  }
};
